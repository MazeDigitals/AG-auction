                  ...
                  <div className='personal-inner-cont'>
                    ...
                    <div className='pronal-info-in'>
                      <ul>
                        ...
                        <li><span>  Email</span>  <Form.Control type='text' aria-label="Username"/>  </li>

                        <li><span>  Mobile 1 </span>  <Form.Control type='text' aria-label="Username"/> </li>

                        <li><span>  Mobile 2 </span>  <Form.Control type='text' aria-label="Username"/> </li>
