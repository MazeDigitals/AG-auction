          ...
          <div className="personal-info">
            ...
            <div className="pers-form">
              <Form>
                ...
                <p>
                  {" "}
                  * Please make sure to enter a valid mobile number as it will
                  be used to receive your activation message
                </p>
              </Form>
            </div>
          </div>
        ...
        <div className="register-sec">
          <div className="personal-info">
            ...
            <div className="regcapt-content">
              <p>
                {" "}
                BY Clicking on Create your account you agree on Emirates Auction{" "}
