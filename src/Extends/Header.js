...
import { Navbar, Container, Nav, Row, Col, Form, Button, Dropdown} from 'react-bootstrap';
              ...
              <div className='hdr-sec'>
                <Row>
                  <Col md={6}>
                    ...
                    <ul>
                      <li><Link to={'/Aboutus'}>About Ag Auction</Link></li>
                  ...
                  <Col md={6}>
                    ...
                    <ul>
                      ...
                      <li className='red-btn'><Link to={'/Register'}>Register </Link></li>
                      <li className='pfr-my'><Dropdown>
